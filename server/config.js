...
module.exports = {
	mongo: {
			...
			apiKey: 'KimqWufo_AfZ2xvNrdckhgHxzigWoT4-'              // MongoLab API key
		},
		security: {
			dbName: 'zahori',                                 	// The name of database
			usersCollection: 'users',                            	// The name of the collection contains user information
			membersCollection: 'fountains',                           // The name of the collection contains congress members information
			user: 'congreso-app',
			password: 'Qabasabslc'
		},
		server: {
